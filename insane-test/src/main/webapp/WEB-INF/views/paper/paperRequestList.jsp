...
<body>
	...
	<aside>
			...
			<div id="sideMenu" align="center">
				...
				<br>
				<a style="text-decoration:none; color:white;" href="requestPage.cr?type=퇴직" onclick="window.open(this.href, 'Popup', 'width=420, height=600'); return false;">퇴직 증명서</a>
				<br>			
			</div>
		</aside>
	<div id="section">
		...
		<div align="cetner">
			...
			<div class="pageArea" align="center">								
				...
				<c:if test="${ requestScope.pi.currentPage > 1 }">
					<c:url var="blistCheck" value="selectList.cr">
