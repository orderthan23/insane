...
<body>
	...
	<div id="section">
		<br>
		<div class="bluerect"></div><span id="pageTitle">공지사항</span><br><br>
		<hr>
		<br><br>		
		<div align="center">
...
<%-- 							<td class="item_td">${ no.status }</td> --%>
	...
	<script>
		function writeNotice() {
			location.href="${pageContext.request.contextPath}/move.no?type=공지";
		}
		
		function deleteNotice() {
			$("#noticeForm").attr("action", "${pageContext.request.contextPath}/deleteList.no")
			$("#noticeForm").submit();
			//location.href="${pageContext.request.contextPath}/deleteList.no";
		}
		...
		$(function() {
			...
			$(".item_td").click(function(){
				...
				//console.log($(this).parent().children(".boardStatus").val());
				if($(this).parent().children(".boardStatus").val() == "비공개"){
					var author = $("#auth").val();
					
					//console.log(author.indexOf('N1'));
					if(author.indexOf('N1') == -1 && author.indexOf('N2') == -1 && author.indexOf('N3') == -1 ){
						alert("접근 권한이 없습니다.");
						return;
					}
				}
