...
<body>
	...
	<div class="section">
		<br>
		<div class="bluerect"></div><span id="pageTitle">전달사항 보기</span><br><br>
		<hr>
		<br><br>		
		<form id="detailForm" method="post" enctype="multipart/form-data">
		<input type="hidden" id="type" name="type" value="${ requestScope.notice.boardType }">
		<input type="hidden" id="boardSeq" name="num" value="${ requestScope.notice.boardSeq }">
		...
		<div class="boardArea">
			<table id="boardTable">
				...
				<%-- <c:if test="${ requestScope.notice.writerEmpNo eq sessionScope.loginUser.empNoSeq }">
